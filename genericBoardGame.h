#ifndef FULL_INTEGRATED_X_O_GENERICBOARDGAME_H
#define FULL_INTEGRATED_X_O_GENERICBOARDGAME_H
...
class FourInARowComputerPlayer : public RandomPlayer {
public:
    FourInARowComputerPlayer(char symbol);
    void get_move(int& x, int& y);
};
...
public:
    PyramidRandomPlayer(char symbol);
    void get_move(int& x, int& y) override;
};

#endif //FULL_INTEGRATED_X_O_GENERICBOARDGAME_H
